...
export async function exportPIRLStoPaGamOQuizGroup(
  ...
  try {
    ...
    const header: (string | null)[][] = [
        ['版本資訊', 'v1.0', null, null, null, '題組共同內容', null, null, '題組個別題目', null, null, null, null, null, null, null, null, '答案', null, null, null],
    ...
    questionsOutput.questions.forEach((q, index) => {
      ...
      // G: 標題多媒體檔名 (null)
      row[6] = articleContent;                        // G: 內容(必填) - Corrected from H to G
      // H: 內容多媒體檔名 (null)
      row[8] = q.question;                            // I: 題目(必填) - Corrected from J to I
      // J: 題目多媒體檔名 (null)
      ...
      // R, S, T are for Option E and its media (null)
